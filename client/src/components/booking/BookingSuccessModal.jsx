  ...
  return (
    <div className=" inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
      <div className="relative w-full max-w-[420px] rounded-3xl bg-surface shadow-2xl animate-[fadeIn_.25s_ease] overflow-hidden">
        ...
        <button
          onClick={onClose}
          className="absolute right-4 top-4 text-xl text-theme hover:opacity-70"
        >
          ✕
        </button>

        {/* Success Header */}
        <div className="flex flex-col items-center px-6 pt-8 pb-6 border-b border-theme">
          <div className="h-20 w-20 rounded-full bg-green-100 flex items-center justify-center">
            <FaCheckCircle className="text-5xl text-green-600" />
          </div>

          <h2 className="mt-5 text-2xl font-bold text-theme">
            Booking Confirmed!
          </h2>
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="border-t border-theme pt-4">
            <Row
              ...
              valueClass="text-green-600 text-xl font-bold"
            />
          </div>
        </div>

        {/* Footer */}
        <div className="border-t border-theme p-5 flex flex-col gap-3">
          <Link
            to="/my-bookings"
            onClick={onClose}
...
function Row({ icon, label, value, valueClass = "font-semibold text-theme" }) {
  return (
